...
import com.mod.web.VehicleController;
...
class VehicleHireBookingApplicationTests {
	...
	void testGetAllVehicles() throws Exception {
		List<Vehicle> allVehicleList = setUpAllVehicles();
		...
		mockMvc.perform(builder).andExpect(
				content().json("[{\"id\":1,\"registrationNumber\":\"REG-1\",\"make\":\"BMW\",\"model\":\"Z4\","
	...
	void testGetVehicleByRegistrationNumber() throws Exception {
		...
		mockMvc.perform(builder).andDo(print());
		mockMvc.perform(builder).andExpect(
				content().json("{\"id\":7,\"registrationNumber\":\"REG-7\",\"make\":\"BMW\",\"model\":\"Z4\","
						+ "\"fuel\":\"Petrol\",\"category\":\"Small car\",\"pricePerDay\":25,"
	...
	void testGetVehicleCost() throws Exception {
		...
		mockMvc.perform(builder).andDo(print());
		mockMvc.perform(builder).andExpect(
				content().string("The Vehicle BMW Z4 Petrol Small car Registration Number REG-7 hiring cost for the "
	...
	void testGetAllVehiclesToHire() throws Exception {
		List<Vehicle> allVehiclesToHire = setUpAllVehiclesToHire();
		...
		mockMvc.perform(builder).andDo(print());
		mockMvc.perform(builder).andExpect(
				content().json("[{\"id\":4,\"registrationNumber\":\"REG-4\",\"make\":\"BMW\",\"model\":\"Z4\","
						+ "\"fuel\":\"Petrol\",\"category\":\"Small car\",\"pricePerDay\":25,"
						+ "\"customer\":\"\",\"hireStartDate\":null,\"hireEndDate\":null},"
	 ...
	 */
	private List<Vehicle> setUpAllVehicles() {
	 ...
	 * @return List of Vehicle
	 */
	private List<Vehicle> setUpAllVehiclesToHire() {
